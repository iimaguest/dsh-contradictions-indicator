...
- [x] Repo age ≥ 1 day
- [x] Open PR on awesome-dsh-plugin with **one** YAML file
      → https://github.com/awesome-dsh-plugin/awesome-dsh-plugin/pull/4322
      (opened 2026-09-04 from fork branch `add-dsh-contradictions-indicator`)
